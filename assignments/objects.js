...
let interns = [
  ...
  {id:2, name: "Kennan", email: "kdiben1@tinypic.com", gender:"M", speak: function(){return `Hello, my name is ${interns[1].name}`}},
  {id:3, name: "Keven", email: "kmummery2@wikimedia.org", gender:"M"},
  {id:4, name: "Gannie", email: "gmartinson3@illinois.edu", gender:"M"},
  {id:5, name: "Antonietta", email: "adaine5@samsung.com", gender:"F", multiplyNums: (a,b)=> a+b}
]
...
console.log(parent.childObject.grandChildObject.name)
console.log(parent.childObject.grandChildObject.age)
